...
if(G_AD_SETUP.vars.has_3frame){
  animation_setup.states.f0 = {
    ...
    "items": [
      ...
      {
        "target" : ".foreground .frame.frame-3",
        "values" : {
          "opacity" : 1
        },
        "duration" : 0.2,
      ...
      {
        "target" : ".foreground .frame.frame-3 span",
        "values" : {
          "opacity" : 1
        },
        "duration" : 0.4,
      ...
      {
        "target": ".foreground .frame.frame-3 .textholder, .imgframe-1",
        "values": {
          "opacity": 0
        },
        "duration" : 0.2,
  ...
  if (G_AD_SETUP.vars.new_logo) {
    animation_setup.states.f0.items.push({
      ...
      "values" : {
        ...
        "stroke" : G_AD_SETUP.vars.v10_f1_fg,
        "opacity" : 1,
      },
      "verb": "set",
      "offset": "frame0+=0.3"
    ...
    animation_setup.states.f0.items.push({
      ...
      "values" : {
        "fill" : G_AD_SETUP.vars.v10_f1_fg
      },
      "verb": "set",
      "offset": "frame0+=0.3"
    });
...
if (G_AD_SETUP.vars.new_logo) {
  ...
  animation_setup.states.f0.items.push({
   ...
   //To display the logo for non-traditional logos
   animation_setup.states.f0.items.push({
    "target" : ".logo",
    "values" : {
      "opacity": 0
...
animation_setup.states.f0.items.push({
 ...
 // Additional animation for MSFT logo
 animation_setup.states.f0.items.push({
  "target" : ".msft",
  "values" : {
    'opacity': 0
    ...
    case '300x250':
        ...
        if (G_AD_SETUP.vars.new_logo) {
            animation_setup.patch.push({ "target" : ".logo #gd_logo .letter",
                "values": {
                    "fill" : G_AD_SETUP.vars.v10_f3_fg
                },
                "duration" : 0.2,
                "verb": "to", 
                "offset": "frame1+=0.5"
            ...
            animation_setup.patch.push({ "target" : ".logo #gd_logo #heart-path-2",
                "values": {
                    "stroke" : G_AD_SETUP.vars.v10_f3_fg
                },
                "duration" : 0.2,
                "verb": "to", 
                "offset": "frame1+=0.5"
